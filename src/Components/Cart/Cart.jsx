...
function Cart() {
    ...
    return (
        <>
            {cartState && <>
                <div className="sidecart-overlay"></div>

                <div className="sidecart-drawer">
                    <div className="sidecart-container">
                        ...
                        <div className="sidecart-header">
                            ...
                            <button onClick={() => dispatch(toggleCart())} className="close-cart-btn">
                        ...
                        <ul className="sidecart-list">
                            <div className="sidecart-list__header">
                                ...
                                <Link onClick={() => dispatch(toggleCart())} className="sidecart-keep-shopping">
                                    Keep shopping
                                </Link>
                            </div>
                    ...
                    <div className="sidecart-footer">
                        ...
                        <Link to={'/cart'} className="sidecart-checkout-btn">
                            CHECK OUT
                        </Link>
                    </div>
                </div>
